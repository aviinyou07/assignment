...
Generated: 1/10/2026, 11:31:04 PM
...
--------------------------------------------------------------------------------
  ...
  3. chat_name (varchar(255)) [DEFAULT: General]
  4. participants (json)
  5. messages (json)
...
--------------------------------------------------------------------------------
  ...
  2. order_id (int) [INDEX, NOT NULL]
  3. writer_id (int) [INDEX, NOT NULL]
  4. status (enum('pending','doable','not_doable')) [DEFAULT: pending]
  5. comment (text)
  6. created_at (datetime) [DEFAULT_GENERATED, DEFAULT: CURRENT_TIMESTAMP]
